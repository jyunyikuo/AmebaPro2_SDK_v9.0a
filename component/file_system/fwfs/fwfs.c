...
//
#define DFT_NOR_USER_SPACE	0x2000
...
int nand_pfw_flush_cache(void *fr);
...
int nor_pfw_update_flash(uint8_t *nor_addr, uint8_t *data, int size)
{
	...
	if (size_a) {
		...
		dcache_clean_by_addr((uint32_t *)tmp_buf, 4096);
		// erase sector
