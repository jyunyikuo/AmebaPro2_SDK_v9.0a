...
extern char gP2PString[41];
extern int UID_Setup;
extern int Config_Reset;
...
void fATUID(void *arg)
{
	...
	memset(gP2PString, 0, 41);
	strncpy(gP2PString, (char *)arg, 40);
	UID_Setup = 1;
exit:
...
void example_doorbell_chime(void)
{
	...
	if (xTaskCreate(example_doorbell_chime_main, ((const char *)"doorbell-chime"), 4096, NULL, tskIDLE_PRIORITY + 1, NULL) != pdPASS) {
